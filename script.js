...
//this fun will set the len of password acc. to the slider movement 
handleSlider();
...
generateBtn.addEventListener('click',()=>{
  ...
  console.log("Startting the journey!");
   //remove old password
   password="";
   //as mentioned in the checkboxes
   ...
   //add ele from array acc. to condition
